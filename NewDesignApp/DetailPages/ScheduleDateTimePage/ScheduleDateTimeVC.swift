...
class ScheduleDateTimeVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        pickDeliveryControl.selectedSegmentTintColor = kOrangeColor
        self.view.backgroundColor = .white
    ...
    func getTimingFromApi(date: String) {
        let parameters: [String: AnyObject] = [
            ...
            "rest_id" : Cart.shared.tempRestDetails.id as AnyObject,//RestaurantCartDeatils.shared.restuarantID as AnyObject
            "order_date": date as AnyObject

        ]
        UtilsClass.showProgressHud(view: self.view)
        WebServices.loadDataFromService(parameter: parameters, servicename: OldServiceType.restaurantTime, forModelType: RestTiming.self) { success in
            UtilsClass.hideProgressHud(view: self.view)
            self.timing = success.data
            self.setTimelist()
    ...
    func setTimelist() {
        ...
        for time in tempTimeList {
            if Cart.shared.orderDate == .Later {
    ...
    @IBAction func dateSubmitAction() {
        ...
        if segmentedControl.selectedSegmentIndex == 1{
            Cart.shared.orderDate = .Today
        }
        if segmentedControl.selectedSegmentIndex == 2{
            Cart.shared.orderDate = .Later
        }
        ...
        else if Cart.shared.orderDate == .Today {
    ...
    func updateUI() {
        ...
        if segmentedControl.selectedSegmentIndex == 0 {
            ...
            dateSubmitButton.backgroundColor = kOrangeColor
            ...
            timeBackBtn.isHidden = true
            dateSubmitButton.backgroundColor = selectedTimeIndex >= 0 ? kOrangeColor : .gGray100
            dateSubmitButton.setTitleColor(color: selectedTimeIndex >= 0 ? .white : kOrangeColor)
        }
        else {
            asapView.isHidden = true
            dateCollection.isHidden = false
            ...
            selectTimeLbl.text = "Select Time \(type)"
            dateSubmitButton.backgroundColor = (selectedTimeIndex >= 0 && selectedDateIndex >= 0) ? kOrangeColor : .gGray100
            dateSubmitButton.setTitleColor(color: (selectedTimeIndex >= 0 && selectedDateIndex >= 0) ? .white : kOrangeColor)
        }
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        if segmentedControl.selectedSegmentIndex == 1 {
           ...
           // }
            ...
            cell.backgroundColor = selectedTimeIndex == indexPath.row ? UIColor.gOrange100 : UIColor.white
            return cell;
        }
        if selectedDateIndex >= 0 {
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "TimeCVCell", for: indexPath as IndexPath) as! TimeCVCell
...
//        }
        ...
        cell.backgroundColor = selectedDateIndex == indexPath.row ? UIColor.gOrange100 : UIColor.white
            return cell;
