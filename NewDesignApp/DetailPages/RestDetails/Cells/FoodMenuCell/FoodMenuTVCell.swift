...
class FoodMenuTVCell: UITableViewCell {
    ...
    let arr = ["Sushi Bar Appetizers", "Soups", "Salads", "Sushi Bar Appetizers", "Soups"]
    var menulist: [RestMenu]?
    var cateringMenuList = [RestInnerMenu]()
    ...
    func updateUI(menulist: [RestMenu]?, selectedmenuType: Int, selectedFiler : Int) {
    ...
    func updateCategoryUI(restItemList: [RestInnerMenu], selectedmenuType: Int, selectedFiler : Int) {
        self.selectedFiler = selectedFiler
