...
//            print(Cart.shared.selectedTime.date)
//            print(Cart.shared.selectedTime.time)
//            print(Cart.shared.selectedTime.heading)
//            if Cart.shared.selectedTime != nil && !Cart.shared.selectedTime.time.isEmpty {
//                lblAsap.text = Cart.shared.selectedTime.heading
//            }
        }
    }
    func setDate() {
    ...
    func updateUI(data: RestDetails?) {
        restData = data
        ...
        deliveryTimeLbl.text = "\(restData?.deliverytime ?? 0.0) Mins"
        ratingLbl.text = "\(restData?.rating ?? 0.0)"
        userRatinglbl.text = "\(restData?.rating_hd1 ?? "")"
        reorderedLbl.text = "\(restData?.rating_hd2 ?? "")"
        let url = restData?.restImage
