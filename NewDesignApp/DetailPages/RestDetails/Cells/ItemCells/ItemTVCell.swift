...
class ItemTVCell: UITableViewCell {
    ...
    func updateUI(itemlist: RestItemList?) {
        ...
        */
        pricePlusLbl.isHidden = itemlist!.getMinimumPrice.count > 1 ? false : true
        itemPriceLbl.text = "\(UtilsClass.getCurrencySymbol())\(itemlist?.getMinimumPrice.first! ?? 0.0)"
