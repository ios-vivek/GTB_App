...
//        if !deliveryZipsArray.contains(AddToCartItmesData.shared.selectedAddress.zip) && !AddToCartItmesData.shared.selectedAddress.zip.elementsEqual(AddToCartItmesData.shared.restaurantDetails.zip){
//            Alert.showDefaultAlert(for: self, message: "Oops! Out of Delivery Radius, We Deliver Within 4 Miles Radius..")
//            return
//        }
